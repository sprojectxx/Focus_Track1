...
CREATE POLICY "Public can view motivational quotes" 
  ON public.motivational_quotes FOR SELECT 
  USING (true);

-- Insert Default Heroic Motivational Quotes
...
CREATE TABLE IF NOT EXISTS public.habits (
  ...
  name TEXT NOT NULL,
  category TEXT NOT NULL DEFAULT 'Core Discipline',
  category_label TEXT,
  description TEXT,
  ...
  schedule_days INT[] DEFAULT '{0,1,2,3,4,5,6}',
  schedule_type TEXT DEFAULT 'daily',
  reminder_enabled BOOLEAN DEFAULT FALSE,
  reminder_time TEXT DEFAULT '08:00',
  target_time TEXT,
  focus_minutes_per_session INT DEFAULT 30,
...
-- ===================================================
-- 5. USER FCM TOKENS TABLE (For Push Notifications)
-- ===================================================
...
-- ===================================================
-- 6. TRIGGER TO AUTOMATICALLY CREATE PROFILE ON GOOGLE SIGN UP
-- ===================================================
...
DECLARE
  random_creed TEXT;
BEGIN
  -- Select a random quote from public.motivational_quotes
  ...
  INSERT INTO public.profiles (id, name, avatar_url, creed)
  VALUES (
    NEW.id,
